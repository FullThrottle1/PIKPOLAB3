...
class DataProcessor(ABC):
    ...
    def run(self) -> None:
        ...
        cleaned_result = self.remove_col_by_name(self._dataset, ['Type'])
        paymentMethods = ['Debit card', 'Credit card']
        cleaned_result = self.get_query(cleaned_result, f"PM == {paymentMethods}")
...
class CsvDataProcessor(DataProcessor):
    ...
    def print_result(self):
        ...
        print("Writing self.result data to cleaned.csv")
        (self.result.to_csv('cleaned.csv', index=False))
